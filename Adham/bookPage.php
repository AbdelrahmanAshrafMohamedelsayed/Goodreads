                    ...
                    <?php if (isset($_SESSION['username'])) { ?>
                        <div class="w-100 d-flex justify-content-center ">
                            <a class="btn bg-main text-white mb-2 buy fs-5" href="<?php
                                                                            echo "../Adham/buy.php?book=$bookISBN&title=" . $data['title']; ?>">Buy</a>
                        </div>
                    <?php } ?>
            ...
            <div class="container bg-light">
                <div class="card bg-light" style="border:0px solid black">
                    <div class="card-body">
                        ...
                        <h5 class="card-subtitle mb-2 text-muted"><a href="../abdo hoda/publishinghouseone.php?ID=<?php echo $data['PHID']; ?>" style="text-decoration:none; color:grey;"><?php echo $data['BookPH'] ?></a></h5>
