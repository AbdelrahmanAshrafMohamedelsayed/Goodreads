...
//if condition to select if he is author or user
if (isset($_SESSION['handle'])) {
    $bookauthor = addslashes($_SESSION['handle']);

    //retrieve information about this author
    $authorcur = "SELECT Fname,facebook,twitter,ProfileImage,linkedin FROM author  WHERE Handle='$bookauthor'";
    ...
    $sql="SELECT COUNT(*) NumberOfBooks FROM book WHERE BookAuthor='$bookauthor';";
    $NumberOfBooks =mysqli_query($connect,$sql);
    $NumberOfBooks=mysqli_fetch_assoc($NumberOfBooks);
    $NumberOfBooks=$NumberOfBooks['NumberOfBooks'];

    //retrieve information about all another authors
    $other = "SELECT Fname,ProfileImage,Minit,Lname,facebook,twitter,linkedin,Handle FROM author WHERE Handle !='$bookauthor' ";
    ...
    $usercur = "SELECT Fname,facebookacc,twitteracc,Image,linkedinacc FROM users  WHERE username='$user'";
    ...
    $sql="SELECT COUNT(*) NumberOfBooks FROM buy WHERE buyer='$user';";
    $NumberOfBooks =mysqli_query($connect,$sql);
    $NumberOfBooks=mysqli_fetch_assoc($NumberOfBooks);
    $NumberOfBooks=$NumberOfBooks['NumberOfBooks'];

    //retrieve information about all another users
    $others = "SELECT Fname,Image,Minit,Lname,facebookacc,twitteracc,linkedinacc,username FROM users WHERE username !='$user' ";
                        ...
                        <div class="card-content">
                            ...
                            <div class="icon-block"><a
                                    href="<?php echo (isset($_SESSION['handle'])) ? $i['facebook'] : $i['facebookacc']; ?>"><i
                                        class="fab fa-facebook-f"></i></a>
                                <a
                                    href="<?php echo (isset($_SESSION['handle'])) ? $i['twitter'] : $i['twitteracc']; ?>">
                                    <i class="fab fa-twitter"></i></a>
                                <a
                                    href="<?php echo (isset($_SESSION['handle'])) ? $i['linkedin'] : $i['linkedinacc']; ?>">
