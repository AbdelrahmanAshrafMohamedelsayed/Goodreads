...
<body>
                ...
                <div>
                    ...
                    <?php if (isset($_SESSION['username'])) { ?>
                        <div class="w-100 d-flex justify-content-center ">
                            <a class="btn bg-main text-white mb-2 buy fs-5" href="<?php
                                                                            echo "../Part1/buy.php?book=$bookISBN&title=" . $data['title']; ?>">Buy</a>
                        </div>
                    <?php } ?>
            ...
            <div class="container bg-light">
                <div class="card bg-light" style="border:0px solid black">
                    <div class="card-body">
                        ...
                        <h5 class="card-subtitle mb-2 text-muted"><a href="../Part2/publishinghouseone.php?ID=<?php echo $data['PHID']; ?>" style="text-decoration:none; color:grey;"><?php echo $data['BookPH'] ?></a></h5>
                        ...
                        <p class="card-text" style="font-size: 1.08rem!important; margin-bottom:3px">Store <b class="ms-2"><a href="../Part2/bookstoreone.php?ID=<?php echo $data['StoreID']; ?>" style="text-decoration:none;"><?php echo $data['BookStore'] ?></a></b> </p>
    ...
    <?php }
    ?>
    <div class="fluid bg-light<?php if (count($reviews) != 0) {
                                    echo ' py-4';
                                } ?> ">
        <div id="data" class="container">
                        ...
                        <div class="d-flex justify-content-between ">
                            <div>
                                ...
                                if (isset($_SESSION['username'])) {
                                    ...
                                    <?php }
                                    if (!SelectAction($_SESSION['username'], $username, $i['BOOKISBN'], $i['ID'], $connect, 'dis')) {
                                    ?>
