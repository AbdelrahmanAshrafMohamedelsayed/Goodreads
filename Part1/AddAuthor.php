...
if (isset($_POST['handle'])) {
    ...
    if (strlen($aerrors) == 0) {
        ...
        if ($Insertion) {
            ...
            header('Location:../Part2/authors.php');
            #header('Location:../Part1/loginPage.php');
        }
        else{
...
<head>
    ...
    <link rel="stylesheet" href="../Part1/loginStyle.css">
    <link rel="stylesheet" href="../Part1/formStyle.css">
...
<body>
    ...
    <div class="d-flex justify-content-center">
            <div class="col-md-6 my-5"><?php include '../Part1/AuthorForm.php' ?></div> 
    </div>
